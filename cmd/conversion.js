...
registerCommand({
  ...
  try {
    let response2 = await axios.get("https://tenor.googleapis.com/v2/featured?key=REDACTED&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=" + encodeURIComponent(emoji1) + "_" + encodeURIComponent(emoji2));
