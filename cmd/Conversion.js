...
let [emoji1, emoji2] = arg[0].split(';');
    ...
    try {
      let response = await axios.get(`https://tenor.googleapis.com/v2/featured?key=REDACTED&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=${encodeURIComponent(emoji1)}_${encodeURIComponent(emoji2)}`);
