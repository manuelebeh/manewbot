...
registerCommand({
  ...
  try {
    let _0x45efbe = await axios.get("https://tenor.googleapis.com/v2/featured?key=REDACTED&contentfilter=high&media_filter=png_transparent&component=proactive&collection=emoji_kitchen_v5&q=" + encodeURIComponent(_0x5c07a2) + "_" + encodeURIComponent(_0x53a174));
